...
export default function DateAndTell() {
  ...
  return (
    <div style={{ fontFamily: "var(--font)", background: "white", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#2563EB", padding: "48px" }}>
  ...
  <HowItWorksCarousel />
      ...
      {page === "privacy" && (
        <div className="legal-page">
          ...
          <h2>12. Contact</h2>
<p>Date and Tell LLC<br />Email: <a href="mailto:hello@dateandtell.com">hello@dateandtell.com</a><br />c/o Northwest Registered Agent, LLC<br />90 State Street, Suite 700, Albany, NY 12207</p>
        </div>
      )}
